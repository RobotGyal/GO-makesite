...
[![Go Report Card](https://goreportcard.com/badge/github.com/robotgyal/YOUR_REPONAME)](https://goreportcard.com/report/github.com/robotgyal/YOUR_REPONAME)
...
$ git remote add origin git@github.com:robotgyal/makesite.git
```
...
- [x] Edit line `4` of `README.md`. Change this line to the following, replacing `robotgyal` and `YOUR_REPONAME` with your GitHub username and repository name respectively.
